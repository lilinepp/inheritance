...
const  int Student:: min_crs = 1; // переменная,для того,чтобы задать минимальный курс.
const  int Student::max_crs = 6; // переменная,для того,чтобы задать максимальный курс
const  int Student::min_rec = 100000; //переменная,для того,чтобы задатьминимальное шестизначное значение номера зачетки
const  int Student::max_rec = 999999;  //переменная,для того,чтобы задать максимальное шестизначное значение номера зачетки
