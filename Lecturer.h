...
private:
	...
	/// </summary>
	int num_hall;	
	const string candidate_sciences="Кандидат наук"; //константные переменные для хранения данных о научной степени
	const string doctor_sciences="Доктор наук";
	const string no_sciences="Нет ученой степени";
public:
	Lecturer();
	Lecturer(const string& _name, const string& _surname, const string& _patronymic,
	const int _age,const string& _name_u, const int _number);
