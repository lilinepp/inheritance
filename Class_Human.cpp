...
int main() {
 ...
 // Human* entrant = new Human ("Петр", "Петров", "Петрович", 18);// динамическое создание
  //Student* freshman = new Student ("Сидр", "Сидоров", "Сидорович", 19,200000, 4, "ВМК-20", "Обучается");
  Lecturer* teacher = new Lecturer ("Иван", "Иванов", "Иванович",20, "ЗабГУ", 203);

   //freshman->add_age(10);                                                     // проверка прибавления к возрасту
  ...
  // teacher->acd_dgr_down();                                                // проверка уменьшения учёной степени до доктора
  // teacher->acd_dgr_down();                                                // проверка уменьшения учёной степени до доктора
